<div tabindex="-1"
    class="fixed bottom-0 start-0 z-50 flex flex-wrap justify-between w-full p-4 border-b border-gray-300 bg-gray-100 border-t">
    ...
    <div class="flex items-center flex-shrink-0 w-full mx-auto sm:w-auto">
        <form class="flex flex-col items-center w-full md:flex-row">
            ...
            <input type="email" id="email" placeholder="Ingresa tu correo"
                ...
                required />
            <x-button amber label="Suscribirme"
